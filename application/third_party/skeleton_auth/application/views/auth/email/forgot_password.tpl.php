<html>
<body>
Per iniciar el procés de restabliment de la contrasenya del vostre compte ( <?php echo $identity;?> ) de l'aplicació d'inventari de <?php echo $organization; ?>, feu clic a l'enllaç següent:

<p>&nbsp;&nbsp;&nbsp;<?php echo anchor('inventory_auth/reset_password/'. $forgotten_password_code, lang('email_forgot_password_link'));?></p>
...
<p>Atentament,<br/>
L'equip de manteniment de l'aplicació d'inventari de <?php echo $organization; ?></p>
